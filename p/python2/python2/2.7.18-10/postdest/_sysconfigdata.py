...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BLDSHARED': '/usr/bin/cc -bundle -undefined dynamic_lookup -fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'CC': '/usr/bin/cc',
 'CCSHARED': '',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--prefix=/usr' '--sysconfdir=/etc' '--localstatedir=/var' '--build=aarch64-apple-darwin20.4.0' '--disable-dependency-tracking' '--disable-debug' '--enable-ipv6' '--without-ensurepip' '--with-system-ffi' '--with-system-expat' '--enable-loadable-sqlite-extensions' '-C' '--without-lto' '--disable-toolbox-glue' 'build_alias=aarch64-apple-darwin20.4.0' 'CC=/usr/bin/cc'",
 ...
 'COVERAGE_INFO': '/buildroot/Python-2.7.18/coverage.info',
 'COVERAGE_REPORT': '/buildroot/Python-2.7.18/lcov-report',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/cc -bundle -undefined dynamic_lookup -fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes',
 'LIBC': '',
 ...
 'LLVM_PROF_MERGER': '/usr/bin/llvm-profdata merge -output=code.profclangd *.profclangr',
 'LN': 'ln',
 'LOCALMODLIBS': '',
 'MACHDEP': 'darwin',
 ...
 'PY_CORE_CFLAGS': '-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes -I. -IInclude -I./Include  -DPy_BUILD_CORE',
 ...
 'abs_builddir': '/buildroot/Python-2.7.18',
 'abs_srcdir': '/buildroot/Python-2.7.18',
