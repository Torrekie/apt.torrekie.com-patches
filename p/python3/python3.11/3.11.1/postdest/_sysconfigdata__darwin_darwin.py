...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/usr/bin/cc -bundle -undefined dynamic_lookup',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'aarch64-apple-darwin20.4.0',
 'BYTESTR_DEPS': '\\',
 'CC': '/usr/bin/cc',
 'CCSHARED': '',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--sysconfdir=/etc' '--localstatedir=/var' "
                "'--build=aarch64-apple-darwin20.4.0' "
                "'--disable-dependency-tracking' '--disable-debug' "
                "'--enable-ipv6' '--without-ensurepip' '--with-system-ffi' "
                "'--with-system-expat' '--enable-shared' "
                "'--with-system-libmpdec' "
                "'--enable-loadable-sqlite-extensions' '-C' '--without-lto' "
                "'build_alias=aarch64-apple-darwin20.4.0' "
                "'CC=/usr/bin/cc'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/buildroot/Python-3.11.1/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/buildroot/Python-3.11.1/lcov-report',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'aarch64-apple-darwin20.4.0',
 ...
 'LDCXXSHARED': '/usr/bin/c++ -bundle -undefined dynamic_lookup',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.dylib',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/cc -bundle -undefined dynamic_lookup',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/usr/include',
 'LIBM': '',
 'LIBMPDEC_A': 'Modules/_decimal/libmpdec/libmpdec.a',
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -Wsign-compare '
                    '-Wunreachable-code -DNDEBUG -g -fwrapv -O3 -Wall -std=c11 '
 ...
 'LIBPL': '/usr/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 ...
 'MODULE__LZMA_CFLAGS': '-I/usr/include',
 'MODULE__LZMA_LDFLAGS': '-L/usr/libexec/xz/lib -llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/usr/libexec/sqlite3/include -I./Modules/_sqlite',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/usr/libexec/sqlite3/lib -lsqlite3',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_LIBRARY_PATH=/buildroot/Python-3.11.1',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_LIBRARY_PATH=/buildroot/Python-3.11.1 ./python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_LIBRARY_PATH=/buildroot/Python-3.11.1 ./python -E '
 ...
 'abs_builddir': '/buildroot/Python-3.11.1',
 'abs_srcdir': '/buildroot/Python-3.11.1',
